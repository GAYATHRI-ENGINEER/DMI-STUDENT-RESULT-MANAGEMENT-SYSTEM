...
<html lang="en">
    <head>
        ...
        <title>DMI Student Result Management System</title>
                        ...
                        <div class="panel login-box">
                            <div class="panel-heading">
                                <div class="panel-title text-center">
                                    <h4>DMI Student Result Management System</h4>
                                </div>
                            </div>
...
{   ?>
<option value="<?php echo htmlentities($result->id); ?>"><?php echo htmlentities($result->ClassName); ?>&nbsp; Passed out year<?php echo htmlentities($result->Section); ?></option>
<?php }} ?>
 </select>
</div>
                        ...
                        <!-- /.panel -->
                        <p class="text-muted text-center"><small>Copyright © 2023 DMI</small></p>
                    </div>
