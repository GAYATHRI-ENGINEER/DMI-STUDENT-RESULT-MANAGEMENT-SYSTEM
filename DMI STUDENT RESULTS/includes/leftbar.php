<div class="left-sidebar bg-black-300 box-shadow ">
                        <div class="sidebar-content">
                            <div class="user-info closed">
                                <img src="http://placehold.it/90/c2c2c2?text=User" alt="DMI STUDENT RESULT MANAGEMENT SYSTEM" class="img-circle profile-img">
                                <h6 class="title">DMI ADMIN</h6>
                                <small class="info">DMI COLLEGE OF EMGINEERING</small>
                            </div>
                            <!-- /.user-info -->
                            ...
                            <div class="sidebar-nav">
                                <ul class="side-nav color-gray">
                                    ...
                                    <li class="has-children">
                                        <a href="#"><i class="fa fa-file-text"></i> <span>Student Department</span> <i class="fa fa-angle-right arrow"></i></a>
                                        <ul class="child-nav">
