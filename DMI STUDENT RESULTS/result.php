...
<html lang="en">
    <head>
        ...
        <title>DMI Result Management System</title>
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-12">
                                    <h2 class="title" align="center">DMI Result Management System</h2>
                                </div>
                            </div>
                            <!-- /.row -->
...
<p><b>Student Department:</b> <?php echo htmlentities($row->ClassName);?>(<?php echo htmlentities($row->Section);?>)
<?php }
